...
public class ReorderedPowerOf2 {
    class Solution {
        public boolean reorderedPowerOf2(int n) {
            ...
            int[] targetDigitFrequencies = getDigitFrequencies(n);
            for (int i = 0; i < 32; i++) {
                int power = (1 << i);
                int[] powerDigitFrequencies = getDigitFrequencies(power);
                if (areEqual(targetDigitFrequencies, powerDigitFrequencies)) {
                    return true;
                }
            }
        ...
        private int[] getDigitFrequencies(int n) {
