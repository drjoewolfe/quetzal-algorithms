...
public class DesignBrowserHistory {
    class BrowserHistory {
        ...
        Stack<String> forwardsHistory;

        public BrowserHistory(String homepage) {
            backwardsHistory = new Stack<>();
            forwardsHistory = new Stack<>();

            backwardsHistory.push(homepage);
        }

        public void visit(String url) {
            forwardsHistory.clear();
            backwardsHistory.push(url);
        }

        public String back(int steps) {
            while(steps > 0 && backwardsHistory.size() > 1) {
                forwardsHistory.push(backwardsHistory.pop());
                steps--;
            }

            return backwardsHistory.peek();
        }

        public String forward(int steps) {
            while(steps > 0 && forwardsHistory.size() > 0) {
                backwardsHistory.push(forwardsHistory.pop());
                steps--;
            }
    ...
    class BrowserHistory_Correct_1 {
        List<String> history;
        int size;
        int index;

        public BrowserHistory_Correct_1(String homepage) {
