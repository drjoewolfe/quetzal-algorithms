...
class GreedyAlgorithmsTest {
    ...
    @Test
    void getBinsForPackingUsingOnlineNextFit() {
        int[] itemWeights;
        ...
        expectedBins = Utilities.constructList(
                ...
                Utilities.constructList(8, 1),
                Utilities.constructList(4, 2, 1)
        );
        bins = GreedyAlgorithms.getBinsForPackingUsingOnlineNextFit(itemWeights, 10);
        ...
        expectedBins = Utilities.constructList(
                Utilities.constructList(2, 5),
                Utilities.constructList(4),
                Utilities.constructList(7, 1),
                Utilities.constructList(3),
    ...
    @Test
    void getBinCountForPackingUsingOnlineFirstFit() {
        int[] itemWeights;

        itemWeights = new int[]{4, 8, 1, 4, 2, 1};
        assertEquals(2, GreedyAlgorithms.getBinCountForPackingUsingOnlineFirstFit(itemWeights, 10));

        itemWeights = new int[]{9, 8, 2, 2, 5, 4};
        assertEquals(4, GreedyAlgorithms.getBinCountForPackingUsingOnlineFirstFit(itemWeights, 10));
    ...
    @Test
    void getBinsForPackingUsingOnlineFirstFit() {
        int[] itemWeights;
        List<List<Integer>> bins;
        List<List<Integer>> expectedBins;
        ...
        itemWeights = new int[]{4, 8, 1, 4, 2, 1};
        expectedBins = Utilities.constructList(
                Utilities.constructList(4, 1, 4, 1),
                Utilities.constructList(8, 2)
        );
        ...
        expectedBins = Utilities.constructList(
                ...
                Utilities.constructList(4, 3),
                Utilities.constructList(7),
                Utilities.constructList(8)
        );
        bins = GreedyAlgorithms.getBinsForPackingUsingOnlineFirstFit(itemWeights, 10);
        QuetzalAssertions.assertListOfListEquals(expectedBins, bins);
    ...
    @Test
    void getBinCountForPackingUsingOfflineFirstFitDecreasing() {
        int[] itemWeights;

        itemWeights = new int[]{4, 8, 1, 4, 2, 1};
        assertEquals(2, GreedyAlgorithms.getBinCountForPackingUsingOfflineFirstFitDecreasing(itemWeights, 10));

        itemWeights = new int[]{9, 8, 2, 2, 5, 4};
        assertEquals(4, GreedyAlgorithms.getBinCountForPackingUsingOfflineFirstFitDecreasing(itemWeights, 10));

        itemWeights = new int[]{2, 5, 4, 7, 1, 3, 8};
        assertEquals(3, GreedyAlgorithms.getBinCountForPackingUsingOfflineFirstFitDecreasing(itemWeights, 10));
    }

    @Test
    void getBinsForPackingUsingOfflineFirstFitDecreasing() {
        int[] itemWeights;
        List<List<Integer>> bins;
        List<List<Integer>> expectedBins;
        ...
        expectedBins = Utilities.constructList(
                Utilities.constructList(8, 2),
                Utilities.constructList(4, 4, 1, 1)
        );
        ...
        expectedBins = Utilities.constructList(
                Utilities.constructList(9),
                Utilities.constructList(8, 2),
                Utilities.constructList(5, 4),
                Utilities.constructList(2)
        );
        bins = GreedyAlgorithms.getBinsForPackingUsingOfflineFirstFitDecreasing(itemWeights, 10);
        QuetzalAssertions.assertListOfListEquals(expectedBins, bins);
